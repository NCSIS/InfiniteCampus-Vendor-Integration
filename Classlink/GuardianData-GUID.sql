/*
07/10/2025 - Updated script to give GUID instead of personID
*/
...
FinishedData AS (
Select 
	CONCAT('g', cg.contactguID) AS sourcedId,
	'' AS status,
	'' AS dateLastModified,
	'TRUE' AS enabledUser,
	od.orgids AS orgSourcedIds,
	'guardian' AS role,
	CONCAT('g', cg.contactGUID) AS username,
	CONCAT('{Fed:g', cg.contactGUID, '}') AS userIds,
	cg.lastName AS familyName,
	cg.firstName AS givenName,
	'' AS middleName,
	CONCAT('g', cg.contactGUID) AS identifier,
